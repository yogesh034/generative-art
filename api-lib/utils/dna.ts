...
const createDna = (layers, rarity='original', rarityWeights) => {
  let randNum: any[] = [];
...
const createUniqueDna = (layers, rarity='original', rarityWeights, dnaListByRarity) => {
  ...
  console.log('-new dna: ' + newDna.join('-'));
